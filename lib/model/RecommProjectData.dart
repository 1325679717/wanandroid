class RecommProjectArray{

  List<RecommProjectData>? data;
  RecommProjectArray.fromJson(Map<String, dynamic> json) {

    if (json['data'] != null && json['data']["datas"] != null) {
      data = <RecommProjectData>[];
      json['data']["datas"].forEach((v) {
        data!.add(RecommProjectData.fromJson(v));
      });
    }
  }
...
class RecommProjectData {
  ...
  RecommProjectData.fromJson(Map<String, dynamic> json) {
